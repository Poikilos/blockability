...
class BAWidgetProgram:
    ...
    def __init__(self, display_size):
        ...
        self.trunk_widget = BAWidget("trunk",pygame.Rect(0,0,display_size[0],display_size[1]))
...
class BAWidget:
    ...
    def set_container_last_clicked_to_key(self):
        if self.container is not None:
            ...
            #print("set container last clicked key:"+str(self.container.last_clicked_key))
